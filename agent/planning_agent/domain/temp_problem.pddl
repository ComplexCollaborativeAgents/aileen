...
(:objects
c_Bread|-00.92|+00.99|+02.27 c_Fridge|-01.00|+00.00|+00.12 c_thor - cell
Bread|-00.92|+00.99|+02.27 Fridge|-01.00|+00.00|+00.12 - interactable
)
...
(:goal (and
		(and  (in Fridge|-01.00|+00.00|+00.12 Bread|-00.92|+00.99|+02.27) (not (opened Fridge|-01.00|+00.00|+00.12)))
	)
)
)